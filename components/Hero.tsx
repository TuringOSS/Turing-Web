...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Watch for theme changes associated with class additions/removals
  ...
  return (
    <div ref={containerRef} className="relative h-screen w-full overflow-hidden bg-white dark:bg-turing-black transition-colors duration-300 flex items-center justify-center">
        ...
        <RoughNotationGroup show={true}>
            ...
            >
               {/* 
                  ...
                  - Using video1.mp4 
                  - Background handles responsive black/white
               */}
               <VideoText 
                  text="TURING"
                  videoSrc="/coding.mp4"
                  className="h-[25vh] md:h-[40vh]  max-w-4xl mx-auto"
               />
            </motion.div>
            ...
            >
              <div className="text-left font-sans text-sm md:text-xl text-stone-600 dark:text-stone-300 max-w-sm tracking-wide leading-relaxed">
                 <p>
                    Defining the <br/>
                    <RoughNotation type="underline" color="#FFD700" strokeWidth={2} padding={[0, 2]}>
                       <span className="text-black dark:text-white font-bold transition-colors">future</span>
                    </RoughNotation> of <br/>
      ...
      >
        ...
        <ArrowDown className="text-black dark:text-white animate-bounce w-6 h-6 transition-colors" />
      </motion.div>
