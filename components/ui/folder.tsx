...
const Folder: React.FC<FolderProps> = ({ color = '#5227FF', size = 1, items = [], className = '', logo, onPaperClick }) => {
  const maxItems = 3;
          ...
          {papers.map((item, i) => {
            ...
            return (
              <div
                ...
                className={`absolute z-20 bottom-[10%] left-1/2 transition-all duration-300 ease-in-out cursor-pointer ${
              ...
              >
                ...
                { i=== 2 && logo && (
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <img src={logo} alt="Folder Logo" className="w-[50%] h-[50%] rounded-full object-contain opacity-90" />
                  </div>
                )}
              </div>
            );
