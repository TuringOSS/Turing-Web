...
export const VideoText = ({
  ...
  return (
    <div className={cn("relative overflow-hidden flex items-center justify-center", className)}>
      ...
      */}
      <div 
        className="absolute inset-0 z-10 flex items-center justify-center bg-white dark:bg-black mix-blend-screen dark:mix-blend-multiply transition-colors duration-300"
      >
